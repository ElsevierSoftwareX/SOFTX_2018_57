...
Namespace Style
    ...
    ''' ---------------------------------------------------------------------------
    ''' <summary>
    ''' Class for providing a textual description of <see cref="eTSDataSetInterval"/>.
    ''' </summary>
    ''' <remarks>
    ...
    Public Class cTimeSeriesDatasetIntervalTypeFormatter
        ...
        Public Function GetDescriptor(ByVal value As Object, _
            ...
            Dim strDescr As String = cResourceUtils.LoadString("TSDATASETINTERVAL_" & strValue.ToUpper, My.Resources.ResourceManager)
        ...
        Public Function GetDescribedType() As System.Type _
            ...
            Return GetType(eTSDataSetInterval)
        End Function
