...
''' </summary>
''' ---------------------------------------------------------------------------
Public Interface IEcosimScenarioAddedOrRemovedPlugin
    Inherits IPlugin
    ...
    ''' -----------------------------------------------------------------------
    Sub EcosimScenarioAdded(dataSource As Object, scenarioID As Integer)
    ...
    ''' of this plugin point will be called.</remarks>
    ''' -----------------------------------------------------------------------
    Sub EcosimScenarioRemoved(dataSource As Object, scenarioID As Integer)
