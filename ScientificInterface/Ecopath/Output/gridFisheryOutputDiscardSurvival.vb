...
Namespace Ecopath.Output
    ...
    Public Class gridFisheryOutputDiscardSurvival
        ...
        Protected Overrides Sub InitStyle()
            ...
            ' Total column
            Me(0, Core.nFleets + 2) = New EwEColumnHeaderCell(SharedResources.HEADER_DISCARD_SURV)
        ...
        Private Sub FillRows(ByVal iRow As Integer, ByVal iGroup As Integer)
            ...
            For iFleet As Integer = 1 To Core.nFleets
                ...
                sVal = fleetOut.DiscardSurvivalByGroup(iGroup)
            ...
            ' Total column
            Me(iRow, Me.ColumnsCount - 1) = New EwECell(sTot, cStyleGuide.eStyleFlags.Sum Or cStyleGuide.eStyleFlags.NotEditable)
        ...
        Private Sub FillTotalsRow()
            ...
            Me(Me.RowsCount - 1, 1) = New EwERowHeaderCell(SharedResources.HEADER_DISCARD_SURV)
            ...
            For iFleet As Integer = 1 To Core.nFleets
                ...
                For iGroup As Integer = 1 To Core.nGroups
                    sFleetTot += fleetOut.DiscardSurvivalByGroup(iGroup)
                Next
